...
<body>
    ...
    <div class="container mx-auto flex justify-between items-center">
      ...
      <nav class="nav-container">
        ...
        <a href="{{ route('about') }}"      class="nav-link {{ request()->routeIs('about*') ? 'active' : '' }}">
          <i class="fa-solid fa-user"></i><span class="label">Sobre mí</span>
        </a>
        <a href="{{ route('projects') }}"   class="nav-link {{ request()->routeIs('projects*') ? 'active' : '' }}">
          <i class="fa-solid fa-briefcase"></i><span class="label">Proyectos</span>
        </a>
        <a href="{{ route('education') }}"  class="nav-link {{ request()->routeIs('education*') ? 'active' : '' }}">
          <i class="fa-solid fa-graduation-cap"></i><span class="label">Educación</span>
        </a>
        <a href="{{ route('experience') }}" class="nav-link {{ request()->routeIs('experience*') ? 'active' : '' }}">
          <i class="fa-solid fa-screwdriver-wrench"></i><span class="label">Experiencia</span>
        </a>
        <a href="{{ route('skills') }}"     class="nav-link {{ request()->routeIs('skills*') ? 'active' : '' }}">
          <i class="fa-solid fa-code"></i><span class="label">Habilidades</span>
        </a>
        <a href="{{ route('blog') }}"       class="nav-link {{ request()->routeIs('blog*') ? 'active' : '' }}">
          <i class="fa-solid fa-newspaper"></i><span class="label">Blog</span>
        </a>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      links.forEach(link => {
        link.addEventListener('click', () => moveIndicator(link), { passive:true });
      });
    });
