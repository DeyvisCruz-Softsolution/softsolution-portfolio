            ...
            <div class="modal-content modal-gallery">
                ...
                <div class="modal-gallery-stage">
                    @foreach($project->gallery as $index => $image)
                     <img src="{{ asset('images/projects/gallery/' . $image) }}"
...
.card-title-vertical {
    ...
    right: 8.5rem;                 /* separación del borde derecho */
...
.card-buttons {
    ...
    left: calc(12rem + 1rem);                 /* separa los botones del número decorativo (5rem = .card-number font-size) */
